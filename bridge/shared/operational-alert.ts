...
const ENTREGAVEIS = new Set([
  ...
  "catchup_degradado",
  // Cliente pediu falar com uma pessoa. O bot já respondeu "te conectei com o Cícero" e o
  // funil parou — o que falta é a pessoa. Sem este alerta, o pedido morre na inbox.
  "pediu_humano",
]);
